// Static console data copied from the design prototype (apps/storyboard/src/data.js).
// Used only by the tabs that are still sample-data mockups: Schedule, Hours,
// Clients, Checklist templates, Reports. Everything else runs on live data.
