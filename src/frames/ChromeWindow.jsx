// Chrome browser window frame — ported from the design handoff (browser-window.jsx).
// Dark macOS theme, tab bar + URL bar; all inline styles + inline SVG.
...
function TabBar({ tabs = [{ title: 'New Tab' }], activeIndex = 0 }) {
  return (
    <div style={{
      ...
      background: C.barBg, paddingRight: 8,
    }}>
      <TrafficLights />
